...
const API_DOMIAN1 = "https://newapi.quiktrak.co/QuikTrak/V1/";//api.m2mglobaltech.com
...
API_URL.GET_ALL_POSITIONS = API_DOMIAN1 + "Device/GetPosInfos";
			...
			if (items && items.length) {
				for (let i = 0; i < items.length; i++) {
					...
					if (type.indexOf('protect') !== -1) {
						...
						ret.Loc8++;
					} else if (type.indexOf('track') !== -1 || type.indexOf('watch') !== -1 || type.indexOf('fw200std') !== -1) { //!added to live
						ret.Live++;
					}
                    /*switch (type){
                        case 'protect':
