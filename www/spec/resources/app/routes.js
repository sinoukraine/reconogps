var routes = [
    ...
    {
        path: '/live/',
        componentUrl: './resources/pages/live.html?v=1.1',
        name: 'live',
        options: {
            transition: 'f7-cover',
        },
    ...
    {
        path: '/gallery/',
        componentUrl: './resources/pages/gallery.html?v=1.1',
        name: 'gallery',
        options: {
            transition: 'f7-cover',
        },
    ...
    {
        path: '/asset-obd-data/',
        componentUrl: './resources/pages/asset-obd-data.html?v=1.4',
        name: 'asset-obd-data',
        options: {
            transition: 'f7-cover',
        },
    ...
    {
        path: '/asset-log-last-alarms/',
        componentUrl: './resources/pages/asset-log-last-alarms.html?v=1.4',
        name: 'asset-log-last-alarms',
        options: {
            transition: 'f7-cover',
        },
    },
    {
        path: '/asset-add-fuel/',
        componentUrl: './resources/pages/asset-add-fuel.html?v=1.4',
        name: 'asset-add-fuel',
        options: {
            transition: 'f7-cover',
        },
    ...
    {
        path: '/shared-assets/',
        componentUrl: './resources/pages/shared-assets/shared-assets.html?v=1.4',
        name: 'shared-assets',
        options: {
            transition: 'f7-cover',
        },
    ...
    {
        path: '/shared-assets/create/',
        componentUrl: './resources/pages/shared-assets/create.html?v=1.4',
        name: 'shared-assets-create',
        options: {
            transition: 'f7-cover',
        },
    },
    {
        path: '/shared-assets/view/',
        componentUrl: './resources/pages/shared-assets/view.html?v=1.4',
  ...
  {
        path: '/geofence-list/',
        componentUrl: './resources/pages/geofence-list.html?v=1.4',
        name: 'geofence-list',
        options: {
            transition: 'f7-cover',
        },
    ...
    },
    {
        ...
        componentUrl: './resources/pages/account-settings.html?v=1.5',
	...
	{
		path: '/share-track/',
		componentUrl: './resources/pages/share-track.html?v=1.3',
		name: 'share-track',
		options: {
			transition: 'f7-cover',
		},
    ...
    {
        path: '/service-interval-list/',
        componentUrl: './resources/pages/service-interval-list.html?v=1.3',
        name: 'service-interval-list',
        options: {
            transition: 'f7-cover',
        },
    },
    {
        path: '/service-interval-history/',
        componentUrl: './resources/pages/service-interval-history.html?v=1.3',
        name: 'service-interval-history',
        options: {
            transition: 'f7-cover',
        },
    },
    {
        ...
        componentUrl: './resources/pages/service-interval.html?v=1.3',
